...
/**
 * This is the item provider adapter for a {@link faultTreeModel.Tree} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TreeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tree_root_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tree_root_feature", "_UI_Tree_type"),
				 FaultTreeModelPackage.Literals.TREE__ROOT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FaultTreeModelPackage.Literals.TREE__EVENTS);
			childrenFeatures.add(FaultTreeModelPackage.Literals.TREE__GATES);
		}
